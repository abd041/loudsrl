...
export default function StudioFounderCta({ className }: StudioFounderCtaProps) {
  return (
    <Link
      href="/contact-us"
      className={`group inline-flex cursor-pointer items-center justify-center gap-4 text-lg ${className ?? ""}`}
    >
      ...
      <svg
        ...
        aria-hidden
      >
        <circle cx="25" cy="25" r="24" stroke="#4E71FF" fill="#4E71FF" strokeWidth={1} />
